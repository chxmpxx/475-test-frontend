      ...
      <div>
        <div class="text-center py-16 ">
          <h2 class="text-6xl font-bold text-yellow-800">
            แก้ไขข้อมูลลูกค้าหมายเลข {{ customer.c_id }}
            <!-- <button
              @click="deleteCus(id)"
            ...
            >
              <font-awesome-icon :icon="['fas', 'times']" /> ลบลูกค้า
            </button> -->
          </h2>
        </div>
...
export default {
  ...
  methods: {
    ...
    async assignData() {
      this.form.c_name = this.customer.c_name;
      this.form.type = this.customer.type;
      this.form.c_phone = this.customer.c_phone;
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            Swal.fire({
              ...
              icon: "success",
              confirmButtonColor: "#3085d6",
              confirmButtonText: "กลับหน้าลูกค้า",
            }).then((result) => {
              if (result.isConfirmed) {
    ...
    deleteCus(id) {
      Swal.fire({
        ...
        text: "ต้องการจะลบข้อมูลลูกค้าหรือไม่",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
