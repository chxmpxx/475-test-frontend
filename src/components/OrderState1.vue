...
export default {
  ...
  data() {
    return {
      ...
      status0: false, // ถ้าขึ้นตัวเรือนจะไม่มีให้เลือกชื่อพนักงาน
  ...
  async created() {
    if (this.o_info.status != "คำสั่งซื้อใหม่") {
      ...
      for (var i = 0; i < this.ot_all.length; i++) {
        if (
          ...
          (this.ot_all[i].task_name == "ขึ้นตัวเรือน" ||
            this.ot_all[i].task_name == "เสร็จสิ้นการขึ้นตัวเรือน")
        ) {
      ...
      if (this.o_info.status == "ขึ้นตัวเรือน") {
        this.status3 = true;
      } else {
  ...
  methods: {
    ...
    async filter() {
      for (var i = 0; i < this.employee_info.length; i++) {
        if (this.employee_info[i].job == "ช่างขึ้นตัวเรือน") {
    ...
    status02() {
      ...
      if (
        ...
        Swal.fire({
          title: "ยืนยันการแจกงานขึ้นตัวเรือน",
          ...
          if (result.isConfirmed) {
            ...
            Swal.fire({
              title: "แจกงานขึ้นตัวเรือนสำเร็จ!",
    ...
    good() {
      Swal.fire({
        title: "ยืนยันการขึ้นตัวเรือนผ่าน",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
        ...
        if (result.isConfirmed) {
          ...
          Swal.fire({
            title: "เสร็จสิ้นการขึ้นตัวเรือน!",
            icon: "success",
            confirmButtonColor: "#3085d6",
            confirmButtonText: "กลับ",
          }).then((result) => {
    ...
    bad() {
      Swal.fire({
        title: "ยืนยันการขึ้นตัวเรือนไม่ผ่าน",
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
